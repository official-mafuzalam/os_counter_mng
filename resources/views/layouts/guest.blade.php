...
<head>
    ...
    <title>{{ config('app.name', 'OctoSync Smart Travel Agency') }}</title>
...
<body class="font-sans text-gray-900 antialiased">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        <div>
            <a href="/">
                <img class="h-20" src="https://octosyncsoftware.com/images/31_12_2023/1704006982.png"
                    alt="Octosync Group Pvt. Ltd.">
            </a>
        </div>
