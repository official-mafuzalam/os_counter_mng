                                                    ...
                                                    <td class="h-px w-px whitespace-nowrap">
                                                        <div class="px-6 py-1.5">
                                                            <a data-item-id="{{ $item->id }}"
                                                                class="inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 hover:underline font-medium edit-link"
                                                                href="{{ route('admin.discount.condition_edit', ['id' => $item->id]) }}">
                                                                Edit
                                                            </a>
                                                        </div>
                                                        <div class="px-6 py-1.5">
